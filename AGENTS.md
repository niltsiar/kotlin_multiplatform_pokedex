...
- [ ] Commit uses Conventional Commits format (`type(scope): description`)
...
**See**: `patterns/testing_patterns.md` for complete Kotest+MockK examples and property test generators
