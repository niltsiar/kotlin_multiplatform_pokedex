...
include(":features:pokemonlist:ui-material")
include(":features:pokemonlist:ui-unstyled")
include(":features:pokemonlist:wiring")
include(":features:pokemonlist:wiring-ui-material")
include(":features:pokemonlist:wiring-ui-unstyled")
...
include(":features:pokemondetail:ui-material")
include(":features:pokemondetail:ui-unstyled")
include(":features:pokemondetail:wiring")
include(":features:pokemondetail:wiring-ui-material")
include(":features:pokemondetail:wiring-ui-unstyled")
