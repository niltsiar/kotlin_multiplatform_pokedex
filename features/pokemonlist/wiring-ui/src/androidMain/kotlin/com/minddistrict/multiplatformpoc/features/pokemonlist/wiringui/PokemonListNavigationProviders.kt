...
/**
 * Android-specific Koin DI module for Pokemon List navigation.
 *
 * Provides the EntryProviderInstaller that registers the PokemonListScreen composable with the navigation graph.
 */
