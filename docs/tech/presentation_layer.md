...
> **Current Pattern**: Direct Integration (see [ios_integration.md](ios_integration.md) for complete guide)
...
**iOS Integration**: See [ios_integration.md](ios_integration.md) for complete patterns
